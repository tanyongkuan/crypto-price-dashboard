  ...
  return (
    <Card className="group relative animate-pulse">
      <div className="flex items-center justify-between">
        <div className="h-6 w-24 rounded bg-gray dark:bg-gray-dark" />
        <div className="h-4 w-4 rounded bg-gray dark:bg-gray-dark" />
      </div>
      <div className="mt-2 flex items-center gap-2">
        <div className="h-8 w-32 rounded bg-gray dark:bg-gray-dark" />
        <div className="flex items-center gap-1">
          <div className="h-5 w-5 rounded bg-gray dark:bg-gray-dark" />
          <div className="h-5 w-16 rounded bg-gray dark:bg-gray-dark" />
        </div>
      </div>
    </Card>
  )
